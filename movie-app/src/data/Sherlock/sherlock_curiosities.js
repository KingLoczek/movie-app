...
export const sherlock_curiosities = [
  {
    id: uuidv4(),
    curiosities:
      'The concept of Mind Palace is not an invention of the screenwriters. It is a method of aiding memory that dates back to ancient rome.',
  },
  {
    id: uuidv4(),
    curiosities:
      'After being cast as Holmes, Benedict Cumberbatch read every original Arthur Conan Doyle story.',
  },
  {
    id: uuidv4(),
    curiosities:
      "Baker Street, the original location of Arthur Conan Doyle's books, is said to now have too much Sherlock-related signage to be used as a filming location for the show. The BBC actually shot exteriors 1 mile east of there, at 187 North Gower Street. (NB: The blue plaque next door is for Giuseppe Mazzini, utterly unrelated).",
  },
  {
    id: uuidv4(),
    curiosities:
      "Interior shots were filmed in the BBC studio in Cardiff. There are 17 steps between the hall and front room on that very Cardiff set. Why? Because in Conan Doyle's A Scandal in Bohemia we find out that's exactly how many steps lead up to their quarters at 221b Baker Street.",
  },
  {
    id: uuidv4(),
    curiosities:
