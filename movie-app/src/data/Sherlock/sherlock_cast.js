...
export const sherlock_cast = [
  ...
  },
  {
    ...
    name: 'Mycroft Holmes',
    description:
      "Mycroft Holmes is Sherlock Holmes' and Eurus Holmes' brother and is traditionally older by seven years. He occupies a minor position in the British government; however it is heavily hinted that he has a much bigger role than he claims.",
  },
  {
    id: uuidv4(),
    actor: 'Una Stubbs',
  ...
  },
  {
    ...
    name: 'Jim Moriarty',
    description:
      "ames Jim Moriarty was the world's only consulting criminal; a stark contrast to his arch nemesis is Sherlock Holmes' similarly unrivaled consulting detective occupation.",
  },
  {
    id: uuidv4(),
    ...
    description:
      'Mary Elizabeth Watson, formerly Morstan, is the identity used by a former assassin. She worked as a nurse in the same clinic as her husband John Watson. She and John have a daughter named Rosamund Mary.',
  },
  {
    id: uuidv4(),
